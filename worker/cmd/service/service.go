...
import (
	...
	http "github.com/luw2007/thor/worker/pkg/http"
...
var fs = flag.NewFlagSet("worker", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "worker")
