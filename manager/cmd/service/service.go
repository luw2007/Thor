...
import (
	...
	http "github.com/luw2007/thor/manager/pkg/http"
...
var fs = flag.NewFlagSet("manager", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "manager")
